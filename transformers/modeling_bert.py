    ...
    def forward(
        ...
        if labels is not None:
            if self.num_labels == 1:
                ...
                # 使用带权重的损失函数
                weight = torch.tensor(
                    [1.0, 1.6764705882352942, 4.510791366906475, 4.86046511627907, 8.472972972972974, 10.45,
                     10.627118644067798, 12.294117647058824, 13.340425531914894, 13.630434782608695, 20.9,
                     22.392857142857142, 22.392857142857142, 23.22222222222222, 23.22222222222222, 24.115384615384617],
                    device='cuda')
                ...
                # 标签平滑
                # loss_fct = LabelSmoothingCrossEntropy(epsilon=0.2)
